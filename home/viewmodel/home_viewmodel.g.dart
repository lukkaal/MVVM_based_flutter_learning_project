...
typedef GetAllSongsRef = AutoDisposeFutureProviderRef<List<SongModel>>; // List<SongModel> 是返回值类型 表示调用 Provider 之后的返回值
...
typedef GetFavSongsRef = AutoDisposeFutureProviderRef<List<SongModel>>; // 函数中的 Ref 在 Riverpod 中也用于管理依赖关系和资源
